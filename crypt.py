...
def bacon(string):
	...
	prompt = 'please enter plaintext containing ' + str((len(to_encrypt))*5) + ' characters: '
...
def dna(string):
	print ('your string: ', string)
	code = ['gca','b','tgc','gac','gaa','ttc','gga','cac','ata','j','aaa','tta','atg','aac','o','cca','caa','aga','agc','aca','u','gta','tgg','x','tac','z']
	encrypted = ''
	to_encrypt = ''
	for letter in string:
		if letter.isalpha():
